...
/**
 * Testcase for class Tx_FormulaEnergy_Domain_Model_Usercheck.
 *
 * @version $Id$
 ...
 */
class Tx_FormulaEnergy_Domain_Model_UsercheckTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_FormulaEnergy_Domain_Model_Usercheck
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_FormulaEnergy_Domain_Model_Usercheck();
	}
